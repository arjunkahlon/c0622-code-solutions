...
if (args.length > 3) {
  ...
  if (args[1] === 'plus' || args[1] === '+') {
    console.log('result:', add.add(args[0], args[2]));
  } else if (args[1] === 'minus' || args[1] === '-') {
    console.log('result:', subtract.subtract(args[0], args[2]));
  } else if (args[1] === 'time' || args[1] === 'times' || args[1] === 'x') {
    console.log('result:', multiply.multiply(args[0], args[2]));
  } else if (args[1] === 'over' || args[1] === '/') {
    console.log('result:', divide.divide(args[0], args[2]));
  } else {
